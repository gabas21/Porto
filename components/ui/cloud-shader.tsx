...
vec3 shadeCloud(vec3 color, vec3 sky, vec2 p, vec2 c, vec2 r, float seed, float t, float dist) {
  ...
  // sample density toward the sun (top-right) for realistic self-shadowing and 3D depth
...
void main() {
  ...
  // soft radiant sun glow, upper area
...
export const CloudShader = ({
  ...
  useEffect(() => {
    ...
    // IntersectionObserver: Pause rendering completely when hero is scrolled out of view
